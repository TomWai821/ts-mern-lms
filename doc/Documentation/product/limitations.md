...
### Architecture
- **3NF-style Schema** 
    - Adopted early to accelerate prototyping (Note: This increases cross‑collection lookups, complicating server‑side RBAC and raising runtime costs)
...
- **Scanner Requirement** 
    - Requires a physical scanner or camera for seamless QR input
